...
package clk_params;
    ...
    localparam int  GW_PLL_IDIV_SEL       = 4;  /* Conform to /lib/gowin_rpll.v*/
    localparam int  GW_PLL_FDIV_SEL       = 2;  /* Conform to /lib/gowin_rpll.v*/
    localparam int  GW_PLL_ODIV_SEL       = 32; /* Conform to /lib/gowin_rpll.v*/
