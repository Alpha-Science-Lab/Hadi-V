...
set_property -dict { PACKAGE_PIN L2   IOSTANDARD LVCMOS33 PULLUP true } [get_ports {i2c_sda}];#Sch name = JA2
set_property -dict { PACKAGE_PIN J2   IOSTANDARD LVCMOS33 PULLUP true } [get_ports {i2c_scl}];#Sch name = JA3
